...
import { AnimatedGlowIcon } from '../../components/AnimatedGlowIcon';
            ...
            >
              <TouchableOpacity onPress={() => startAssessment(assessment)}>
                <View style={styles.cardHeader}>
                  <AnimatedGlowIcon size={40} glowColors={['#A78BFA','#FDE047']} bgColors={['#0F172A','#6D28D9']}>{assessment.icon}</AnimatedGlowIcon>
                ...
                <View style={styles.cardFooter}>
                  ...
                  <LinearGradient colors={['#FF8A00', '#FFD700']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.startButton}>
